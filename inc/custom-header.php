...
function chd_portfolio_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'chd_portfolio_custom_header_args', array(
		...
		'height'                 => 250,
		'flex-height'            => true,
		'wp-head-callback'       => 'chd_portfolio_headerstyle',
	) ) );
}
add_action( 'after_setup_theme', 'chd_portfolio_custom_header_setup' );

if ( ! function_exists( 'chd_portfolio_headerstyle' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see chd_portfolio_custom_header_setup().
 */
function chd_portfolio_headerstyle() {
